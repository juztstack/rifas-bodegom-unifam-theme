...
/* harmony export */ });
/* harmony import */ var _router_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./router.js */ "./src/js/modules/raffles/router.js");
/* harmony import */ var _store_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./store.js */ "./src/js/modules/raffles/store.js");
/* harmony import */ var _controller_order_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./controller/order.js */ "./src/js/modules/raffles/controller/order.js");
/* harmony import */ var _controller_dashboard_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./controller/dashboard.js */ "./src/js/modules/raffles/controller/dashboard.js");
/* harmony import */ var _controller_raffle_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./controller/raffle.js */ "./src/js/modules/raffles/controller/raffle.js");
/* harmony import */ var _controller_new_order_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./controller/new-order.js */ "./src/js/modules/raffles/controller/new-order.js");
/* harmony import */ var _model_order_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./model/order.js */ "./src/js/modules/raffles/model/order.js");
/* harmony import */ var _model_raffle_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./model/raffle.js */ "./src/js/modules/raffles/model/raffle.js");
...
class RaffleAdminApp {
  constructor() {
    // Inicializar Store
    this.store = new _store_js__WEBPACK_IMPORTED_MODULE_1__["default"]();
    ...
    // Inicializar Models
    this.models = {
      order: new _model_order_js__WEBPACK_IMPORTED_MODULE_6__["default"](),
      raffle: new _model_raffle_js__WEBPACK_IMPORTED_MODULE_7__["default"]()
    };

    // Inicializar Controllers
    this.controllers = {
      dashboard: new _controller_dashboard_js__WEBPACK_IMPORTED_MODULE_3__["default"](this.models.order),
      order: new _controller_order_js__WEBPACK_IMPORTED_MODULE_2__["default"](this.models.order),
      raffle: new _controller_raffle_js__WEBPACK_IMPORTED_MODULE_4__["default"](this.models.raffle),
      newOrder: new _controller_new_order_js__WEBPACK_IMPORTED_MODULE_5__["default"](this.models.order, this.models.raffle)
    };
  ...
  initRouter() {
    this.router = new _router_js__WEBPACK_IMPORTED_MODULE_0__["default"]();
    console.log('🚦 Router inicializado');
  }
}
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (RaffleAdminApp);

/***/ }),

/***/ "./src/js/modules/raffles/controller/dashboard.js":
/*!********************************************************!*\
  !*** ./src/js/modules/raffles/controller/dashboard.js ***!
  \********************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
    ...
    return {
      ...
      get filteredOrders() {
        ...
        if (this.filters.search) {
          ...
          filtered = filtered.filter(o => o.order_number.toLowerCase().includes(search) || o.customer_name.toLowerCase().includes(search) || o.customer_email.toLowerCase().includes(search));
        }
        return filtered;
      },
...
/***/ "./src/js/modules/raffles/controller/new-order.js":
/*!********************************************************!*\
  !*** ./src/js/modules/raffles/controller/new-order.js ***!
  \********************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (NewOrderController);

/***/ }),

/***/ "./src/js/modules/raffles/controller/order.js":
/*!****************************************************!*\
  !*** ./src/js/modules/raffles/controller/order.js ***!
  \****************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
    ...
    return {
      ...
      async uploadProofAdmin(installmentNumber) {
        ...
        input.onchange = async e => {
          ...
          this.processing = true;
          try {
            const result = await orderModel.uploadPaymentProofAdmin(this.order.id, installmentNumber, file);
            if (result.success) {
...
/***/ "./src/js/modules/raffles/controller/raffle.js":
/*!*****************************************************!*\
  !*** ./src/js/modules/raffles/controller/raffle.js ***!
  \*****************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
      ...
      async loadRaffle(id) {
        ...
        try {
          ...
          if (data) {
            ...
            this.raffle.prizes = Array.isArray(data.prizes) && data.prizes.length > 0 ? JSON.parse(JSON.stringify(data.prizes)) : [{
              title: '',
              description: '',
              image: '',
              detail: ''
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (RaffleController);

/***/ }),

/***/ "./src/js/modules/raffles/model/order.js":
/*!***********************************************!*\
  !*** ./src/js/modules/raffles/model/order.js ***!
  \***********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./src/js/modules/raffles/model/raffle.js":
/*!************************************************!*\
  !*** ./src/js/modules/raffles/model/raffle.js ***!
  \************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (RaffleModel);

/***/ }),

/***/ "./src/js/modules/raffles/router.js":
/*!******************************************!*\
  !*** ./src/js/modules/raffles/router.js ***!
  \******************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./src/js/modules/raffles/store.js":
/*!*****************************************!*\
  !*** ./src/js/modules/raffles/store.js ***!
  \*****************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _modules_raffles_app_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modules/raffles/app.js */ "./src/js/modules/raffles/app.js");



// Instanciar la aplicación (SIN router todavía)
const RaffleApp = new _modules_raffles_app_js__WEBPACK_IMPORTED_MODULE_1__["default"]();
...
window.addEventListener("alpine:init", () => {
  alpinejs__WEBPACK_IMPORTED_MODULE_0__["default"].data("RaffleAppAdmin", () => ({
  ...
  alpinejs__WEBPACK_IMPORTED_MODULE_0__["default"].data("RaffleAppDashboardView", () => RaffleApp.controllers.dashboard.data());
  alpinejs__WEBPACK_IMPORTED_MODULE_0__["default"].data("RaffleAppOrderView", () => RaffleApp.controllers.order.data());
  alpinejs__WEBPACK_IMPORTED_MODULE_0__["default"].data("RaffleAppRaffleListView", () => RaffleApp.controllers.raffle.listData());
  alpinejs__WEBPACK_IMPORTED_MODULE_0__["default"].data("RaffleAppRaffleFormView", () => RaffleApp.controllers.raffle.formData());
  alpinejs__WEBPACK_IMPORTED_MODULE_0__["default"].data("RaffleAppNewOrderView", () => RaffleApp.controllers.newOrder.data());
...
/******/ })()
;
//# sourceMappingURL=juzt.admin-raffles.scripts.js.map